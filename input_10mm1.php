...
<body>
<form action="proses_dt_mm.php" method="post">
	<table width="900" align="center" border="1">
    	<tr>
        	<td><a href="index.php">Beranda</a></td>
        	<td><a href="input_10mm1.php">10 MM 1</a></td>
            <td><a href="halaman/input_10mm2.php">10 MM 2</a></td>
            <td><a href="halaman/input_10tkp1.php">10 TKP 1</a></td>
            <td><a href="halaman/input_10tkp2.php">10 TKP 2</a></td>
            <td><a href="halaman/input_10ap1.php">10 AP 1</a></td>
            <td><a href="halaman/input_10ap2.php">10 AP 2</a></td>
        </tr>
        <tr>
        	<td colspan="7"><img src="image/02.jpg" width="900" height="100" /></td>
        </tr>
        <tr>
        	<td colspan="8">Silahkan Input Biodata 10 MM 1</td>
        </tr>	
        <tr>
