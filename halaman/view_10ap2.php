...
$lihat=mysql_query("select *from 10ap2 ");
while($data=mysql_fetch_array($lihat))
{
echo "<tr><td colspan='2'>$data[nm_sis]</td><td>$data[kls]</td> <td colspan='2'>$data[jurusan] </td><td colspan='2'><a href='proses_dt_ap2.php?no=$data[no]'>hapus</a> | <a href='edit_view_10ap2.php?no=$data[no]'>edit </a> </td></tr> ";
}
echo "</table>
<a href=input_10ap2.php>Input Data Lagi </a>
</center>";
?>
</body>
</html>
