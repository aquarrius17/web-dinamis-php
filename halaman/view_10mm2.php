...
<tr>
	<td width='900' colspan='7'><marquee>Selamat Data Di Halaman Melihat Hasil Data 10 MM 2</marquee></td>
</tr>

<tr><td colspan='2'>Nama Depan</td><td>Kelas </td><td colspan='2'>Jurusan</td><td colspan='2'>AKSI </td></tr> ";
$lihat=mysql_query("select *from 10mm2 ");
while($data=mysql_fetch_array($lihat))
{
echo "<tr><td colspan='2'>$data[nm_sis]</td><td>$data[kls]</td> <td colspan='2'>$data[jurusan] </td><td colspan='2'><a href='proses_dt_mm2.php?no=$data[no]'>hapus</a> | <a href='edit_view_10mm2.php?no=$data[no]'>edit </a> </td></tr> ";
}
echo "</table>
<a href=input_10mm2.php>Input Data Lagi </a>
</center>";
?>
</body>
</html>
